...
my %pbx_config = (
  lab   => [ 'lab',   '10.254.1.2',  '5023', 'username',  'password',  'telnet', '' ],
  production   => [ 'production',   '10.30.2.4',  '5023', 'username',  'password',  'telnet', '' ],
  switcha      => [ 'switcha', '10.30.2.4', '5023', 'username', 'password', 'telnet', ''],
  switchb      => [ 'switchb', '10.30.2.14', '5023','username', 'password', 'telnet', ''],
);
